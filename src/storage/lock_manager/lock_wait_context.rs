...
pub struct LockWaitContextSharedState {
    ...
    ///    encountering lock at step 3.
    /// 6. Then the request becomes unable to be canceled by timeout or other
    ///    possible errors. In worst cases, the request may stuck in TiKV
    ///    forever.
    ///
